 ...
 */
void HybridModelClass::Hybrid_IfActionSubsystem(real_T rtu_In1, real_T *rty_Csa)
{
  /* Inport: '<S2>/In1' */
  *rty_Csa = rtu_In1;
}
 ...
 */
void HybridModelClass::Hybrid_IfActionSubsystem1(real_T rtu_In1, real_T
  *rty_Out1)
{
  /* Inport: '<S3>/In1' */
  *rty_Out1 = rtu_In1;
...
/* Model step function */
void HybridModelClass::step()
{
  real_T rtb_Merge;
  real_T rtb_Merge1;

  /* Outputs for Atomic SubSystem: '<Root>/Hybrid controller' */
  ...
  /* End of Outputs for SubSystem: '<Root>/Hybrid controller' */
  ...
  {                                    /* Sample time: [0.2s, 0.0s] */
    if ((rtmGetTFinal((&Hybrid_M))!=-1) &&
        !((rtmGetTFinal((&Hybrid_M))-(&Hybrid_M)->Timing.taskTime0) > (&Hybrid_M)
  ...
  (&Hybrid_M)->Timing.taskTime0 = (&Hybrid_M)->Timing.clockTick0 * (&Hybrid_M)
    ->Timing.stepSize0 + (&Hybrid_M)->Timing.clockTickH0 * (&Hybrid_M)
    ->Timing.stepSize0 * 4294967296.0;
}

/* Model initialize function */
void HybridModelClass::initialize()
{
  /* Registration code */
...
void HybridModelClass::terminate()
{
  /* (no terminate code required) */
}

/* Constructor */
HybridModelClass::HybridModelClass():
  Hybrid_U()
  ,Hybrid_Y()
  ,Hybrid_M()
{
...
RT_MODEL_Hybrid_T * HybridModelClass::getRTM()
{
  return (&Hybrid_M);
}
